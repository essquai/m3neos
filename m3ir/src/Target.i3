...
CONST
  TypeNamesFixedWidth = ARRAY IRType OF TEXT {
  ...
  TypeNamesDotted = ARRAY IRType OF TEXT {
    "Word.8",  "Int.8",
    "Word.16", "Int.16",
    "Word.32", "Int.32",
    "Word.64", "Int.64",
  ...
  TypeNames = ARRAY IRType OF TEXT {
    "Word8",  "Int8",
    "Word16", "Int16",
    "Word32", "Int32",
    "Word64", "Int64",
  ...
  SignedType = ARRAY IRType OF BOOLEAN {
...
CONST
  OrdinalType = ARRAY IRType OF BOOLEAN {
...
CONST
  FloatType = ARRAY IRType OF BOOLEAN {
...
VAR (*CONST*)
  ...
  Longint   := Int64;
  Long      := Word64;
  Longreal  := Float_type{IRType.LReel, Precision.Long, 64, 64, 8, Float{Precision.Long, 0, -1.79769313486231570x+308}, Float{Precision.Long, 0, 1.79769313486231570x+308}};
VAR
  Extended  := Float_type{IRType.XReel, Precision.Extended, 64, 64, 8, Float{Precision.Extended, 0, -1.79769313486231570x+308}, Float{Precision.Extended, 0, 1.79769313486231570x+308}};

CONST
  (*                   cg_type, size, align, pack, bytes, min, max *)
  Addr32    = Int_type{IRType.Addr,   32, 32, 32, 4, TInt.Zero, TWord.Max32};
  Addr64    = Int_type{IRType.Addr,   64, 64, 64, 8, TInt.Zero, TWord.Max64};
  Int8      = Int_type{IRType.Int8,    8,  8,  8, 1, TInt.Min8, TInt.Max8};
  Int16     = Int_type{IRType.Int16,  16, 16, 16, 2, TInt.Min16, TInt.Max16};
  Int32     = Int_type{IRType.Int32,  32, 32, 32, 4, TInt.Min32, TInt.Max32};
  Int64     = Int_type{IRType.Int64,  64, 64, 64, 8, TInt.Min64, TInt.Max64};
  Word8     = Int_type{IRType.Word8,   8,  8,  8, 1, TInt.Zero,  TWord.Max8};
  Word16    = Int_type{IRType.Word16, 16, 16, 16, 2, TInt.Zero, TWord.Max16};
  Word32    = Int_type{IRType.Word32, 32, 32, 32, 4, TInt.Zero, TWord.Max32};
  Word64    = Int_type{IRType.Word64, 64, 64, 64, 8, TInt.Zero, TWord.Max64};
  Char      = Word8;
  Void      = Int_type{IRType.Void,  0,  8,  0, 0, TInt.Zero, TInt.Zero};
  Real      = Float_type{IRType.Reel, Precision.Short, 32, 32, 4, Float{Precision.Short, 0, -3.40282346638528860x+38}, Float{Precision.Short, 0, 3.40282346638528860x+38}};
...
VAR (*CONST*)
  Atomic_lock_free: ARRAY [IRType.Word8 .. IRType.Addr] OF BOOLEAN;
