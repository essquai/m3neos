...
(* Modified from file M3IR.m3.  Changes are numerous, but the
...
FROM M3IR IMPORT BitSize, BitOffset, No_label;


TYPE 
  U = M3IR.T BRANDED "IRIO_Tee.T" OBJECT
    child2: M3IR.T;
  OVERRIDES
