...
IMPORT IRIO_Rd, IRIO_BinRd, MxConfig, Target;
IMPORT LLVM_HOST, Version;
...
PROCEDURE DoIt () =
  VAR
    ...
    LM3llvmDebugLev: LLVM_HOST.m3llvmDebugLevTyp;
    cg             : LLVM_HOST.U;
    triple,dataRep : TEXT;
    targetIndex : INTEGER;
  BEGIN
    ...
    IF GInIsBinary THEN
      IRIO_BinRd.Inhale(rd_in, cg);
    ELSE
      IRIO_Rd.Inhale(rd_in, cg);
    END (*IF*);
