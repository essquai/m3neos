...
IMPORT IR, Expr, ExprRep, Type, Int, LInt, IntegerExpr, TInt, Target;
IMPORT TargetMap;
  ...
  BEGIN
    ...
    ELSIF (e2 # NIL)
      ...
      ELSE
        ...
        IR.Extract_mn (cg_type, TRUE, log, TargetMap.CG_Size[cg_type] - log);
      END;
    ELSE
      IF (e1 = NIL) THEN e1 := p.a; END;
      ...
      Expr.Compile (e1);
      Expr.Compile (e2);
      IR.Div (Type.IRType (p.type), Expr.GetSign (e1), Expr.GetSign (e2));
    END;
  END Compile;
