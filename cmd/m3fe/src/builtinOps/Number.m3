...
IMPORT IR, CallExpr, Expr, ExprRep, Type, Procedure, Card, Error, ArrayExpr;
  ...
  BEGIN
    ...
    ELSE
      ...
      ELSIF TInt.Subtract (max, min, tmp)
        ...
        IR.Load_integer (Target.Integer.cg_type, num);
      ELSE
        Error.Warn (2, "result of NUMBER too large");
        IR.Load_integer (Target.Integer.cg_type, Target.Integer.max);
