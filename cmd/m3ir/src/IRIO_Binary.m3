...
(* Map must match IRIO_Binary.i3. If you change them see the notes there. *)
CONST
  Map = ARRAY Op OF Desc {
    ...
    (* The rest are not in the file form, see IRIO_Binary.i3 for why, but the data is useful. *)
