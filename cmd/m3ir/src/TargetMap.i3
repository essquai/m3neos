...
FROM Target IMPORT IRType, Precision, Int_type, Float_type;
...
VAR(* CONST *)
  ...
  CG_Align       : ARRAY IRType OF CARDINAL;
  (* Minimum type alignment in bits. *)

  CG_Align_bytes : ARRAY IRType OF CARDINAL;
  (* Minimum type alignment in 8-bit bytes. *)

  CG_Size        : ARRAY IRType OF CARDINAL;
  (* Minimum type size in bits. *)

  CG_Bytes       : ARRAY IRType OF CARDINAL;
