MODULE M3IR_AssertFalse;

IMPORT M3IR, M3IR_Asm;
IMPORT Target;
...
REVEAL
T = Public BRANDED "M3IR_AssertFalse.T" OBJECT
OVERRIDES    
...
<*NOWARN*>PROCEDURE set_error_handler(self: T; p: M3IR_Asm.ErrorHandler) = BEGIN AssertFalse(); END set_error_handler;
