...
REVEAL
T = Public BRANDED "M3IR_DoNothing.T" OBJECT
OVERRIDES
...
<*NOWARN*>PROCEDURE declare_temp(self: T; byte_size: ByteSize; alignment: Alignment; type: Type; typeid: TypeUID; in_memory: BOOLEAN; typename: Name): Var = BEGIN RETURN NIL; END declare_temp;
