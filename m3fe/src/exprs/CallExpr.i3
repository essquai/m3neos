...
TYPE
  ...
  T_ = Expr.T OBJECT
         proc   : Expr.T;
         args   : Expr.List;
         tmp    : IR.Val;         (* for use by the Prep methods *)
         align  : IR.Alignment;   (* for use by the Prep methods *)
...
TYPE
  ...
  CompilerBR  = PROCEDURE (t: T;  true, false: IR.Label;  freq: IR.Frequency);
...
PROCEDURE NotBoolean     (t: T;  true, false: IR.Label;  freq: IR.Frequency);
PROCEDURE PrepNoBranch   (t: T;  true, false: IR.Label;  freq: IR.Frequency);
PROCEDURE NoBranch       (t: T;  true, false: IR.Label;  freq: IR.Frequency);
